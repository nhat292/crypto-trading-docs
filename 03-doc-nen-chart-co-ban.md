...
- S/R không phải một đường kẻ chính xác tuyệt đối mà là một **vùng giá** —
  giá thường xuyên "xuyên qua" một chút rồi mới phản ứng thật.
- Một vùng S/R bị phá vỡ dứt khoát (breakout) có thể đổi vai trò: hỗ trợ cũ
  trở thành kháng cự mới và ngược lại.
...
- **Sideway**: giá dao động trong một vùng, không tạo đỉnh/đáy mới rõ ràng.
...
| Khung | Vai trò |
|---|---|
| Daily / 4H | Xác định xu hướng chính, vùng S/R quan trọng |
| 1H / 15m | Tìm điểm vào lệnh cụ thể theo hướng của khung lớn |
| 5m hoặc nhỏ hơn | Tinh chỉnh điểm vào chính xác (chỉ dùng khi đã thành thạo, dễ nhiễu tín hiệu) |
