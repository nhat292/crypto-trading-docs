...
- Không tăng risk để "gỡ nhanh" sau khi thua, và không tăng risk vì "đang tự
  tin" sau chuỗi thắng — cả hai đều là bẫy tâm lý (xem file 06).
...
- Có thể dời SL theo hướng có lợi (trailing stop) khi lệnh đã đi đúng hướng,
  để bảo toàn lợi nhuận đã có.
...
- Không all-in một lệnh, dù setup có đẹp đến đâu — thị trường luôn có thể đi
  ngược dự đoán.
