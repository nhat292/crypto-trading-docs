...
Phần lớn thua lỗ của trader mới không đến từ thiếu kiến thức kỹ thuật, mà từ
việc vi phạm chính kế hoạch đã đặt ra vì cảm xúc. Nhận diện được các bẫy tâm
lý dưới đây là bước đầu để tránh chúng.
...
- **Vì sao nguy hiểm**: đây là cách nhanh nhất biến một khoản lỗ nhỏ, chấp
  nhận được, thành cháy tài khoản — vì quyết định được đưa ra trong trạng
  thái cảm xúc tiêu cực, không phải phân tích tỉnh táo.
...
- **Vì sao nguy hiểm**: SL tồn tại để giới hạn lỗ ở mức đã chấp nhận trước —
  phá vỡ nó nghĩa là để cảm xúc quyết định thay cho kế hoạch.
...
1. Viết checklist ra giấy/note, không làm trong đầu — cảm xúc dễ "lách luật"
   hơn khi không có gì ghi lại rõ ràng.
2. Ghi nhật ký mọi lệnh, kể cả lệnh thắng do may mắn (không theo kế hoạch) —
   xem [10-nhat-ky-giao-dich.md](10-nhat-ky-giao-dich.md).
3. Chấp nhận rằng thua lỗ là chi phí hoạt động bình thường của nghề trading,
   không phải thất bại cá nhân.
